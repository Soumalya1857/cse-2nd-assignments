...
int main()
{
    ...
    while(1)
    {
        ...
        switch(choice)
        {
                ...
                case 4:delete_something();break;
                case 5:driver_size_of_a_list();break;
                case 6: compare_two_lists();break;
                case 7: merge_two_lists();break;
                case 8: reverse_print_a_list();break;
...
void driver_size_of_a_list()
{
        ...
        int choice;
        scanf("%d",&choice);
        int result = size_of_a_list(choice);
...
void compare_two_lists()
{
        ...
        else
        {
                ...
                if(count == 0) printf("the two lists are equal!!\n");
        }
}
